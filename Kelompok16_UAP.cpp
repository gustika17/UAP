#include <iostream>     //Kelompok 16
#include <conio.h>     //Ghulam Daris Fauzan (2217051044)
#include <windows.h>  //Gustika Dwi Mardini (2257051004)
                     //Armi Yusnita        (2217051156)
...
void instructions() {
	...
	cout<<"\n3. Tekan 'p' untuk menjeda permainan ";
	cout<<"\n4. Tekan 'Escape' untuk keluar dari game";
...
int main() {
    ...
    do{
		...
		system("cls");
		gotoxy(10,5); cout<<" -----------------------------"; 
		gotoxy(10,6); cout<<" |        Tyrex Berlari      | ";  
		gotoxy(10,7); cout<<" ----------------------------- ";
		gotoxy(10,9); cout<<"1. Gass         ";
		gotoxy(10,10); cout<<"2. Ingfo        ";	 
		gotoxy(10,11); cout<<"3. gak mau main ";
